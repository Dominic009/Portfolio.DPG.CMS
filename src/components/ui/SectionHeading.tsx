...
const SectionHeading = ({
  ...
  return (
    <div className="relative text-center md:text-left">
      ...
      <h2
        className={`text-gray-200/10 text-4xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6 absolute top-0 left-0 h-full flex items-center justify-center `}
      >
        {bgHeading}
      </h2>
    </div>
